...
class CustomiesEntityFactory {
	 ...
	 */
	public function registerEntity(string $entityClass, string $identifier, ?Closure $creationFunc = null, string $behaviourId = ""): void {
		EntityFactory::getInstance()->register($entityClass, $creationFunc ?? static function (World $world, CompoundTag $nbt) use ($entityClass): Entity {
